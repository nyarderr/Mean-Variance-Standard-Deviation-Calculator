...
If a list containing less than 9 elements is passed into the function, a ValueError exception with the message: "List must contain nine numbers" is passed. The values in the returned dictionary are lists and not Numpy arrays.
